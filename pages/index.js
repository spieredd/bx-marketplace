...
export default function Home() {
  ...
  const deleteOffer = async (offerId) => {
    console.log(offerId);
    try {
      // Assuming offers have unique IDs stored as their document key
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 ring-1 ring-white/10">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        <li>
                          <h2 className="text-sm text-gray-400 mb-4 font-bold">
                            Navigation
                          </h2>
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-black/10 px-6 ring-1 ring-white/5">
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li>
                  <h2 className="text-gray-400 text-sm mb-2 font-bold">
                    Categories
                  </h2>
                ...
                <li>
                  <div className="text-sm font-bold leading-6 text-gray-400">
                    Start posting
                  </div>
                  {!user && <SignIn />}
                  {user && (
                ...
                {user && (
                  <>
                    <button
                      ...
                      type="button"
                      class="inline-flex items-center gap-x-2 rounded-md bg-indigo-600 px-3.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Sell
                      <svg
                      ...
                      <div className="w-full border-gray-200 px-4 py-5 sm:px-6">
                        <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                          <div className="ml-4 mt-4 flex items-start justify-start">
                            ...
                            <div className="flex top-0 items-start ml-4 mt-4 flex flex-shrink-0"></div>
                          </div>
                        </div>
                        <div className="mt-4">
                        ...
                        <div className="mt-2 flex items-center h-10 gap-2">
                          <div
                            style={{
                              backgroundColor: `var(--${offer.category.color})`,
                              color: `var(--${offer.category.color})`,
                            }}
                          ...
                          {user && user.email === offer.email && (
                            <button
                              type="button"
                              onClick={() => deleteOffer(offer.id)}
                              className="rounded flex items-center gap-2 bg-red-700 px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-red-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                ...
                return (
                  <li key={request.id} className="px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-3 flex justify-between items-center">
                      ...
                      <a
                        className="rounded bg-red-300 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-red-400"
                        target="_blank"
